...
plotdisplay.forEach(option => {
    option.addEventListener('click', () => {
        // alert('test');
        document.querySelector('button.active1').classList.remove('active1');
...
//     option.addEventListener('click', () => {
//         document.querySelector('button.active2').classList.remove('active2');
...
//     document.querySelector('select.time-month');
//     monthchoose.classList.add('active-monthyear');
// })

// yearchoose.addEventListener('change', () => {
//     document.querySelector('select.time-month');
//     yearchoose.classList.add('active-monthyear');
// })
